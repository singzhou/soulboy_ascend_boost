...
#define OPS_LOG_D(OPS_DESC, fmt, ...)                            \
    dlog_debug(0, "[%s]" fmt, __func__, ##__VA_ARGS__)
#define OPS_LOG_I(OPS_DESC, fmt, ...)                            \
    dlog_info(0, "[%s]" fmt, __func__, ##__VA_ARGS__)
#define OPS_LOG_W(OPS_DESC, fmt, ...)                            \
    dlog_warn(0, "[%s]" fmt, __func__, ##__VA_ARGS__)
#define OPS_LOG_E(OPS_DESC, fmt, ...)                            \
    dlog_error(0, "[%s]" fmt, __func__, ##__VA_ARGS__)
#define OPS_LOG_EVENT(OPS_DESC, fmt, ...)                        \
    dlog_event(0, "[%s]" fmt, __func__, ##__VA_ARGS__)
#endif
