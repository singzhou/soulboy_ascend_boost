...
if (ENABLE_TEST)
    option(ENABLE_OPS_KERNEL          "Build ops kernel."               OFF)
else()
...
get_filename_component(OPS_ADV_UTILS_KERNEL_INC     "${OPS_ADV_DIR}/src/ops-transformer/common/include/kernel"  REALPATH)
...
if (BUILD_OPEN_PROJECT)
    # 与基础 CANN 配套关系检查
    option(CHECK_COMPATIBLE      "check compatibility"         OFF)
    if (CHECK_COMPATIBLE)
        set(_param
