...
set(UT_PATH ${CMAKE_CURRENT_SOURCE_DIR}/src/tests/ut/framework_normal)
...
if (OP_API_UT)
  ...
  # Keep OPBASE discovery and target creation in one find-module.
  include(${CMAKE_CURRENT_LIST_DIR}/modules/FindOPBASE.cmake)
endif()
